				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="<?php echo base_url(); ?>images/image_banner/slide1.jpg"> 
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>images/image_banner/slide2.jpg"> 
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>images/image_banner/slide3.jpg"> 
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>images/image_banner/slide4.jpg"> 
						</div> 
					</div>
				</div>
